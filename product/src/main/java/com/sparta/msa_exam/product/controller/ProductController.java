...
public class ProductController {
    ...
    // 상품 목록 조회 API
    @GetMapping
    public ResponseEntity<List<ProductResponse>> getProducts(@RequestParam(value = "ids", required = false) List<Long> productIds) {
        List<ProductResponse> response = productService.getProducts(productIds);
